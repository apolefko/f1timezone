...
<ul>
    ...
    <li><strong>Asia-Pacific races</strong> (${raceLink(opener)}, ${raceLink(races.find(r => r.slug.startsWith("japan")))}) mean overnight or very early morning viewing.</li>
</ul>
...
<p>The season runs from the ${raceLink(opener)} in Melbourne (race day ${fmtDate(opener.sessions.race, opener.timezone)}) to the ${raceLink(finale)} finale at Yas Marina on ${fmtDate(finale.sessions.race, finale.timezone)} — ${races.length} rounds in total. The <a href="/races/">full calendar with US session times is here</a>, but three scheduling notes stand out:</p>
<ul>
